...
if [ ! -f editor/swagger-editor.war ]; then
  ...
  wget --quiet --no-check-certificate "https://github.com/swagger-api/swagger-inflector/raw/feature/scripts/scripts/bin/swagger-editor.war" -O editor/swagger-editor.war
fi

echo "...fetching editor scripts"
wget --quiet --no-check-certificate "https://github.com/swagger-api/swagger-inflector/raw/feature/scripts/scripts/editor.xml" -O editor/editor.xml
...
wget --quiet --no-check-certificate "https://raw.githubusercontent.com/swagger-api/swagger-inflector/feature/scripts/scripts/pom.xml" -O ./pom.xml

echo "...fetching web.xml"
wget --quiet --no-check-certificate "https://raw.githubusercontent.com/swagger-api/swagger-inflector/feature/scripts/scripts/web.xml" -O src/main/webapp/WEB-INF/web.xml
chmod a+x ./editor.sh
